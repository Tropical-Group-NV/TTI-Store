                ...
                <div class="float-left">
                    <div class="flex">
                        <div class="relative w-full">
                            <form action="{{ route('crm.index') }}">
                            <input value="{{ $search }}" name="search" type="search" id="search-dropdown" class="rounded-l-lg block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-r-lg border-l-gray-50 border-l-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Search CRM" required>
                            <button style="background-color: #0069ad" type="submit" class="absolute top-0 right-0 p-2.5 text-sm font-medium text-white bg-blue-700 rounded-r-lg border border-blue-700 hover:bg-blue-800 ">
                                ...
                                <span class="sr-only">Search CRM...</span>
                            </button>
                            </form>
                        </div>
                    </div>
