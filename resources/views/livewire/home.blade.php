...
{{--                                                @if($item->SalesTaxCodeRefFullName != 'Non')--}}
{{--                                                    <div class="card bg-green-600 whitespace-nowrap" style="color: white; font-size: 15px; width: 150px; text-align: center; cursor: pointer">incl. 10% BTW</div>--}}
{{--                                                    @else--}}
{{--                                                    <div class="card bg-primary whitespace-nowrap" style="color: white; font-size: 15px; width: 120px; text-align: center">incl. 0% BTW</div>--}}
{{--                                                @endif--}}
