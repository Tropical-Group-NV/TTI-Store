                        ...
                        <x-jet-dropdown align="right" width="48" style="">
                            ...
                            <x-slot name="content" style="z-index: 10">
                                ...
                                @auth()
                                    ...
                                    @endif
                                @endauth
                                <x-jet-dropdown-link target="_blank" href="https://www.ttistore.com">
...
{{--            </x-jet-responsive-nav-link>--}}
            ...
            @if(\Illuminate\Support\Facades\Auth::user()->users_type_id == 2)
                <x-jet-responsive-nav-link target="_blank" href="https://www.ttistore.com/index.php?r=viewqbcustomer%2Fcustomer-near-me">
                    {{ __('Customers Near Me') }}
                </x-jet-responsive-nav-link>
                @endif
                <x-jet-responsive-nav-link target="_blank" href="https://www.ttistore.com">
                    {{ __('Go to TTISTORE 1.0') }}
                </x-jet-responsive-nav-link>
            @else
