...
//        $visitFreq = CustomerVisitFrequency::query()->limit(300)->get();
        ...
        {
            $customers = ViewQBCustomer::query()->whereNot('location', null)->orderBy('last_order', "DESC")->get(['ListID','FullName', 'location', 'visits_frequency', 'last_visit', 'last_order', 'flag']);
            return view('visits.visits', compact('customers'));
        }
